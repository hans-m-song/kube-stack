...
export interface IngressRouteSpec {
  /**
   * EntryPoints defines the list of entry point names to bind to. Entry points have to be configured in the static configuration. More info: https://doc.traefik.io/traefik/v2.7/routing/entrypoints/ Default: all.
   *
  ...
  /**
   * TLS defines the TLS configuration. More info: https://doc.traefik.io/traefik/v2.7/routing/routers/#tls
   *
...
export interface IngressRouteSpecRoutes {
  ...
  /**
   * Match defines the router's rule. More info: https://doc.traefik.io/traefik/v2.7/routing/routers/#rule
   *
  ...
  /**
   * Middlewares defines the list of references to Middleware resources. More info: https://doc.traefik.io/traefik/v2.7/routing/providers/kubernetes-crd/#kind-middleware
   *
  ...
  /**
   * Priority defines the router's priority. More info: https://doc.traefik.io/traefik/v2.7/routing/routers/#priority
   *
...
export interface IngressRouteSpecTls {
  /**
   * CertResolver defines the name of the certificate resolver to use. Cert resolvers have to be configured in the static configuration. More info: https://doc.traefik.io/traefik/v2.7/https/acme/#certificate-resolvers
   *
  ...
  /**
   * Domains defines the list of domains that will be used to issue certificates. More info: https://doc.traefik.io/traefik/v2.7/routing/routers/#domains
   *
  ...
  /**
   * Options defines the reference to a TLSOption, that specifies the parameters of the TLS connection. If not defined, the `default` TLSOption is used. More info: https://doc.traefik.io/traefik/v2.7/https/tls/#tls-options
   *
...
export interface IngressRouteSpecRoutesServices {
  ...
  /**
   * Sticky defines the sticky sessions configuration. More info: https://doc.traefik.io/traefik/v2.7/routing/services/#sticky-sessions
   *
...
export interface IngressRouteSpecTlsOptions {
  /**
   * Name defines the name of the referenced TLSOption. More info: https://doc.traefik.io/traefik/v2.7/routing/providers/kubernetes-crd/#kind-tlsoption
   *
  ...
  /**
   * Namespace defines the namespace of the referenced TLSOption. More info: https://doc.traefik.io/traefik/v2.7/routing/providers/kubernetes-crd/#kind-tlsoption
   *
...
export interface IngressRouteSpecTlsStore {
  /**
   * Name defines the name of the referenced TLSStore. More info: https://doc.traefik.io/traefik/v2.7/routing/providers/kubernetes-crd/#kind-tlsstore
   *
  ...
  /**
   * Namespace defines the namespace of the referenced TLSStore. More info: https://doc.traefik.io/traefik/v2.7/routing/providers/kubernetes-crd/#kind-tlsstore
   *
...
export interface IngressRouteTcpSpec {
  ...
  /**
   * TLS defines the TLS configuration on a layer 4 / TCP Route. More info: https://doc.traefik.io/traefik/v2.7/routing/routers/#tls_1
   *
...
export interface IngressRouteTcpSpecRoutes {
  /**
   * Match defines the router's rule. More info: https://doc.traefik.io/traefik/v2.7/routing/routers/#rule_1
   *
  ...
  /**
   * Priority defines the router's priority. More info: https://doc.traefik.io/traefik/v2.7/routing/routers/#priority_1
   *
...
export interface IngressRouteTcpSpecRoutesServices {
  ...
  /**
   * ProxyProtocol defines the PROXY protocol configuration. More info: https://doc.traefik.io/traefik/v2.7/routing/services/#proxy-protocol
   *
...
/**
 * Middleware is the CRD implementation of a Traefik Middleware. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/overview/
 *
 * @schema Middleware
 */
...
export interface MiddlewareSpec {
  /**
   * AddPrefix holds the add prefix middleware configuration. This middleware updates the path of a request before forwarding it. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/addprefix/
   *
  ...
  /**
   * BasicAuth holds the basic auth middleware configuration. This middleware restricts access to your services to known users. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/basicauth/
   *
  ...
  /**
   * Buffering holds the buffering middleware configuration. This middleware retries or limits the size of requests that can be forwarded to backends. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/buffering/#maxrequestbodybytes
   *
  ...
  /**
   * Chain holds the configuration of the chain middleware. This middleware enables to define reusable combinations of other pieces of middleware. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/chain/
   *
  ...
  /**
   * CircuitBreaker holds the circuit breaker middleware configuration. This middleware protects the system from stacking requests to unhealthy services, resulting in cascading failures. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/circuitbreaker/
   *
  ...
  /**
   * Compress holds the compress middleware configuration. This middleware compresses responses before sending them to the client, using gzip compression. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/compress/
   *
  ...
  /**
   * DigestAuth holds the digest auth middleware configuration. This middleware restricts access to your services to known users. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/digestauth/
   *
  ...
  /**
   * ErrorPage holds the custom error middleware configuration. This middleware returns a custom page in lieu of the default, according to configured ranges of HTTP Status codes. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/errorpages/
   *
  ...
  /**
   * ForwardAuth holds the forward auth middleware configuration. This middleware delegates the request authentication to a Service. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/forwardauth/
   *
  ...
  /**
   * Headers holds the headers middleware configuration. This middleware manages the requests and responses headers. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/headers/#customrequestheaders
   *
  ...
  /**
   * InFlightReq holds the in-flight request middleware configuration. This middleware limits the number of requests being processed and served concurrently. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/inflightreq/
   *
  ...
  /**
   * IPWhiteList holds the IP whitelist middleware configuration. This middleware accepts / refuses requests based on the client IP. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/ipwhitelist/
   *
  ...
  /**
   * PassTLSClientCert holds the pass TLS client cert middleware configuration. This middleware adds the selected data from the passed client TLS certificate to a header. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/passtlsclientcert/
   *
  ...
  /**
   * RateLimit holds the rate limit configuration. This middleware ensures that services will receive a fair amount of requests, and allows one to define what fair is. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/ratelimit/
   *
  ...
  /**
   * RedirectRegex holds the redirect regex middleware configuration. This middleware redirects a request using regex matching and replacement. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/redirectregex/#regex
   *
  ...
  /**
   * RedirectScheme holds the redirect scheme middleware configuration. This middleware redirects requests from a scheme/port to another. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/redirectscheme/
   *
  ...
  /**
   * ReplacePath holds the replace path middleware configuration. This middleware replaces the path of the request URL and store the original path in an X-Replaced-Path header. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/replacepath/
   *
  ...
  /**
   * ReplacePathRegex holds the replace path regex middleware configuration. This middleware replaces the path of a URL using regex matching and replacement. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/replacepathregex/
   *
  ...
  /**
   * StripPrefix holds the strip prefix middleware configuration. This middleware removes the specified prefixes from the URL path. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/stripprefix/
   *
  ...
  /**
   * StripPrefixRegex holds the strip prefix regex middleware configuration. This middleware removes the matching prefixes from the URL path. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/stripprefixregex/
   *
...
export interface MiddlewareSpecBasicAuth {
  /**
   * HeaderField defines a header field to store the authenticated user. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/basicauth/#headerfield
   *
...
export interface MiddlewareSpecBuffering {
  ...
  /**
   * RetryExpression defines the retry conditions. It is a logical combination of functions with operators AND (&&) and OR (||). More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/buffering/#retryexpression
   *
...
export interface MiddlewareSpecErrors {
  ...
  /**
   * Service defines the reference to a Kubernetes Service that will serve the error page. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/errorpages/#service
   *
...
export interface MiddlewareSpecForwardAuth {
  ...
  /**
   * AuthResponseHeadersRegex defines the regex to match headers to copy from the authentication server response and set on forwarded request, after stripping all headers that match the regex. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/forwardauth/#authresponseheadersregex
   *
...
export interface MiddlewareSpecIpWhiteList {
  /**
   * IPStrategy holds the IP strategy configuration used by Traefik to determine the client IP. More info: https://doc.traefik.io/traefik/v2.7/middlewares/http/ipwhitelist/#ipstrategy
   *
...
/**
 * MiddlewareTCP is the CRD implementation of a Traefik TCP middleware. More info: https://doc.traefik.io/traefik/v2.7/middlewares/overview/
 *
...
/**
 * ServersTransport is the CRD implementation of a ServersTransport. If no serversTransport is specified, the default@internal will be used. The default@internal serversTransport is created from the static configuration. More info: https://doc.traefik.io/traefik/v2.7/routing/services/#serverstransport_1
 *
...
/**
 * TLSOption is the CRD implementation of a Traefik TLS Option, allowing to configure some parameters of the TLS connection. More info: https://doc.traefik.io/traefik/v2.7/https/tls/#tls-options
 *
 * @schema TLSOption
 */
...
export interface TlsOptionSpec {
  /**
   * ALPNProtocols defines the list of supported application level protocols for the TLS handshake, in order of preference. More info: https://doc.traefik.io/traefik/v2.7/https/tls/#alpn-protocols
   *
  ...
  /**
   * CipherSuites defines the list of supported cipher suites for TLS versions up to TLS 1.2. More info: https://doc.traefik.io/traefik/v2.7/https/tls/#cipher-suites
   *
  ...
  /**
   * CurvePreferences defines the preferred elliptic curves in a specific order. More info: https://doc.traefik.io/traefik/v2.7/https/tls/#curve-preferences
   *
...
/**
 * TLSStore is the CRD implementation of a Traefik TLS Store. For the time being, only the TLSStore named default is supported. This means that you cannot have two stores that are named default in different Kubernetes namespaces. More info: https://doc.traefik.io/traefik/v2.7/https/tls/#certificates-stores
 *
 * @schema TLSStore
 */
...
/**
 * TraefikService is the CRD implementation of a Traefik Service. TraefikService object allows to:  - Apply weight to Services on load-balancing  - Mirror traffic on services More info: https://doc.traefik.io/traefik/v2.7/routing/providers/kubernetes-crd/#kind-traefikservice
 *
...
export interface TraefikServiceSpecWeighted {
  ...
  /**
   * Sticky defines whether sticky sessions are enabled. More info: https://doc.traefik.io/traefik/v2.7/routing/providers/kubernetes-crd/#stickiness-and-load-balancing
   *
